            ...
            <div>
              ...
              <div className="relative z-10 mt-8 space-y-1.5 text-center">
                ...
                <p className="text-muted-foreground">
                  Utilizes machine learning algorithms to detect complex fraud patterns in ISO 20022 messages.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
            <div>
              ...
              >
                ...
                {/* Add the rest of the SVG elements and defs here */}
              </svg>
              <div className="relative z-10 mt-8 space-y-1.5 text-center">
                <h2 className="text-lg font-medium text-foreground">
                ...
                <p className="text-muted-foreground">
                  Continuously analyzes financial transactions in real-time, ensuring immediate fraud detection and prevention.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Ensures full compliance with ISO 20022 standards and other financial regulations, reducing legal risks.
                  </p>
                </div>
              </div>
